        ...
        <div className="container-page relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              <div
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 backdrop-blur-md border border-white/60 shadow-sm animate-fade-in opacity-0 hover:scale-105 transition-transform duration-300"
              ...
              <h1
                className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-slate-900 tracking-tight leading-[1.1] animate-slide-up opacity-0"
              ...
              <p
                className="text-base sm:text-lg text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-slide-up opacity-0"
                style={{ animationDelay: "200ms" }}
              >
                GateOn is the all-in-one platform for modern events. Vivid
                pages, seamless ticketing, and an experience your attendees will
                love.
              </p>

              <div
                className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-slide-up opacity-0"
              ...
              <p
                className="text-sm text-slate-400 font-medium animate-slide-up opacity-0 flex items-center justify-center lg:justify-start gap-2"
            ...
            >
              <div className="relative z-10 bg-white/40 backdrop-blur-xl rounded-[2.5rem] p-4 border border-white/50 shadow-2xl shadow-brand/10 transform rotate-[-2deg] hover:rotate-0 transition-transform duration-700">
                ...
                <div
                  className="absolute -right-6 bottom-20 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-card animate-float hidden sm:block"
      ...
      <section className="py-16 container-page">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500 mt-2 text-lg">
              Discover the most popular events happenning this weekend.
            </p>
          </div>
          <Link
            to="/events"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {events
            .filter(
              (e) =>
                (!e.status || e.status === "published") && Boolean(e.trending),
            )
            .slice(0, 6)
            .map((event, index) => (
              <div
        ...
        {!events.some(
          (e) => (!e.status || e.status === "published") && Boolean(e.trending),
        ) && (
          <p className="text-sm text-slate-500 mt-6">
            No trending events right now. Explore all events to discover what’s
            new.
          </p>
        )}
